package com.brady.coreframe.net.core;

import com.brady.coreframe.net.core.bean.NetResponse;
import com.brady.coreframe.net.core.config.NetConstants;
import com.brady.coreframe.net.core.interfaces.IRequestListener;
import com.brady.coreframe.net.core.interfaces.ITag;
import com.brady.coreframe.FastApplication;
import com.brady.coreframe.aosp.volley.VolleyProcess;
import com.brady.coreframe.net.core.bean.BasicRequest;
import com.brady.coreframe.net.core.bean.TagBean;
import com.brady.coreframe.net.core.interfaces.IErrorInfo;
import com.brady.coreframe.net.core.interfaces.IProgressLoad;
import com.brady.coreframe.utils.LogUtils;
import com.brady.coreframe.utils.device.NetUtils;
