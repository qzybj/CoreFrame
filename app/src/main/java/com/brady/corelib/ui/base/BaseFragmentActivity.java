...
import com.brady.corelib.module.fragmentdialog.AlertDialogFragment;
...
/**
 * Activity的base基类：以Fragment实现的
 */
public abstract class BaseFragmentActivity extends FrameBaseActivity
		implements ITitleBarClickListener {
...
//------------- 界面弹出框，提示信息等实现 --------------
	...
	protected void goActivity(Class cls,String title,Bundle args){
		JumpBaseUtil.go(this, JumpUtil.buildJumpInfo(cls,title,args));
	}
