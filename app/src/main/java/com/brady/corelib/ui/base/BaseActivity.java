package com.brady.corelib.ui.base;
...
import com.brady.corelib.module.login.util.AccountHelper;
import com.brady.libutil.app.ActivityStack;
...
public abstract class BaseActivity extends FrameBaseActivity {
	...
	public final void setTitlebarLeftText(String titleStr) {
		if (mTitlebar_tv_left != null&& StringUtil.isNotEmpty(titleStr)) {
			//TextViewUtil.setTextViewDrawable(mTitlebar_tv_left,null);
	...
	public final void setTitlebarLeftDrawable(int drawableResid,int padding) {
		if (mTitlebar_tv_left != null) {
			if (drawableResid>0) {
				...
				if (drawable != null) {
					TextViewUtil.setDrawable(mTitlebar_tv_left,drawable,padding,0);
				}
			}else{
				TextViewUtil.setDrawable(mTitlebar_tv_left,null,padding,0);
			}
		}
	}
	...
	public final void setTitlebarContent(String titleStr) {
		if (mTitlebar_tv_content != null &&StringUtil.isNotEmpty(titleStr)) {
	...
	public final void setTitlebarRightText(String titleStr) {
		if (mTitlebar_tv_right != null&&StringUtil.isNotEmpty(titleStr)) {
			//TextViewUtil.setTextViewDrawable(mTitlebar_tv_right,null);
	...
	public final void setTitlebarRightDrawable(int drawableResid,int padding) {
		if (mTitlebar_tv_right != null&&drawableResid>0) {
			Drawable drawable= getResources().getDrawable(drawableResid);
			if (drawable != null) {
				TextViewUtil.setDrawable(mTitlebar_tv_right,drawable,padding,0);
			}
		}
	}
	/**标题栏   -  左边按钮触发事件*/
