...
public class AccountUtils {
    ...
    public static void setUserInfo(UserInfoBean userInfo, String account, String password) {
        ...
        SPUtil.instance().setString("account", account);
        SPUtil.instance().setString("password", password);
    }
    ...
    public static AccountInfo getAccount() {
        ...
        accountInfo.account = SPUtil.instance().getString("account");
        accountInfo.password = SPUtil.instance().getString("password");
        return accountInfo;
    }
    ...
    public static void LoginOut() {
        userInfoBean = null;
        //清除记录的账号
        SPUtil.instance().setString("account", "");
        SPUtil.instance().setString("password", "");
    }
