package com.brady.appframe.core.view.popwindow.impl;
...
import com.brady.appframe.core.view.popwindow.BasePopupWindow;
...
public class VideoPopWindowView implements IPopupSubView, View.OnClickListener,
    ...
    private void initUI() {
        ...
        View adapterView = ViewUtil.loadView(parent, R.layout.pop_video);
