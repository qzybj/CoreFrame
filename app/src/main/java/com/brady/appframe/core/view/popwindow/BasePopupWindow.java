package com.brady.appframe.core.view.popwindow;
...
import com.brady.appframe.core.view.popwindow.i.IClosePopupWindow;
import com.brady.appframe.core.view.popwindow.i.IPopupCallback;
import com.brady.appframe.core.view.popwindow.i.IPopupSubView;


public class BasePopupWindow implements OnDismissListener,
		OnClickListener, IClosePopupWindow {
	//透明度
	public static final float ALPHA_POPUP_WINDOW = 0.6f;
	...
	public void setContentView(View view, RelativeLayout.LayoutParams lp){
		if( popupWindow != null ){
			rootView = (RelativeLayout) LayoutInflater.from(activity).inflate(R.layout.pop_base_popupwindow, null);
