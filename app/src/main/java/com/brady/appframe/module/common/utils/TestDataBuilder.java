...
import com.brady.corelib.ui.ContainerActivity;
...
public class TestDataBuilder {
    ...
    public static MainItemBean getJumpBeanF(Class cls, String describe, Class fragment) {
        Bundle args = IntentUtil.setBString(null, KEY_FRAGMENT, fragment.getName());
    ...
    public static MainItemBean getJumpBeanF(Class cls, String describe, Class fragment, Bundle args) {
        args = IntentUtil.setBString(args, KEY_FRAGMENT, fragment.getName());
        return buildJumpBean(new JumpUtils.JumpInfo(cls,describe,args));
    }
    ...
    public static MainItemBean buildJumpBean(JumpBaseUtil.IJumpInfo jumpInfo) {
        ...
        bean.setImageUrl(imageUrls[RandomUtil.getRandom(imageUrls.length-1)]);
