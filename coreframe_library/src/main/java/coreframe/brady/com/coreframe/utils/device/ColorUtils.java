package coreframe.brady.com.coreframe.utils.device;
...
public class ColorUtils {
    ...
    public static StateListDrawable newSelector(Context context, int idNormal, int idPressed, int idFocused, int idUnable) {
        ...
        Drawable normal = idNormal == NONE ? null : context.getResources().getDrawable(idNormal);
        Drawable pressed = idPressed == NONE ? null : context.getResources().getDrawable(idPressed);
        Drawable focused = idFocused == NONE ? null : context.getResources().getDrawable(idFocused);
        Drawable unable = idUnable ==NONE ? null : context.getResources().getDrawable(idUnable);
     ...
     * @return
     */
    public static StateListDrawable newSelector(Context context, int idNormal, int idFocused){
        StateListDrawable bg=new StateListDrawable();
        Drawable normal = idNormal == NONE ? null : context.getResources().getDrawable(idNormal);
        Drawable focused = idFocused == NONE ? null : context.getResources().getDrawable(idFocused);
