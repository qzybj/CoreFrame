...
public class DeviceUtils {
    ...
    public static String getIMEI() {
    	if( StringUtils.isEmpty(imei)){
    		//改成只取一次
    		TelephonyManager telephonyManager = (TelephonyManager) FastApplication.instance().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static String getIPAddress(Context con) {
    	int netConnectType = NetUtils.getNetConnectType(con);
    	switch (netConnectType) {
    	case NetUtils.NETWORK_TYPE_UNKNOWN:{//no Net Connected
    		return null;
    	}
    	case NetUtils.NETWORK_TYPE_WIFI:{//wifi
